            ...
            <section className="gradient-trust text-white py-16 md:py-24">
                <div className="max-w-5xl mx-auto px-4 text-center">
                    ...
                    <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm rounded-full 
                          px-4 py-1.5 mb-6 text-sm font-medium">
                        <span className="w-2 h-2 rounded-full bg-green-400 animate-pulse" />
                        זמינים עכשיו — 24/7
                    </div>

                    <h1 className="font-rubik font-extrabold text-3xl md:text-5xl lg:text-6xl leading-tight mb-4">
                        שירותי גרירה מהירים
                        <br />
                        <span className="text-alert-300">בצפון הארץ</span>
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                        <a
                         ...
                         font-semibold text-base shadow-lg hover:bg-green-600 transition-colors w-full sm:w-auto
                         justify-center"
                        >
                            <svg
