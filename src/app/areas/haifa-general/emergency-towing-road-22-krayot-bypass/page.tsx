...
export const metadata: Metadata = {
  ...
  description: "נתקעתם בכביש 22 עוקף קריות? גרר דחוף זמין עבורכם 24/7. שירות מקצועי לרכבים פרטיים ומסחריים. צרו קשר עכשיו לחילוץ מהיר."
};
  ...
  return (
    <main className="flex flex-col w-full">
      ...
      <section className="py-16 container mx-auto px-4">
        ...
        <p className="mb-4">אנו מספקים מענה מיידי לכל סוגי התקלות בכביש עוקף קריות. בין אם מדובר בתקלה מכנית, תאונה או מצבר גמור, הצוות שלנו מצויד בכלים המתקדמים ביותר.</p>
        <p className="text-red-600 font-bold mb-4">חשוב להבהיר: אנו מתמחים ברכבים פרטיים, רכבי שטח ומסחריים בלבד. איננו מספקים שירותי גרירה לאופנועים.</p>
        
        <div className="bg-gray-100 p-8 rounded-xl mt-8">
          ...
          <ul className="list-disc pr-6 space-y-2">
            ...
            <li>צוות מיומן ומקצועי עם ניסיון רב בחילוץ רכבים.</li>
          </ul>
        </div>
      </section>
    </main>
