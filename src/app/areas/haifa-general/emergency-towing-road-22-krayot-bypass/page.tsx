  ...
  return (
    <main>
      ...
      <section className="py-16 container mx-auto px-4">
        ...
        <p className="mb-4">אנו מתמחים בחילוץ וגרירת רכבים פרטיים, מסחריים ורכבי 4x4 לאורך ציר כביש 22. אנו מבינים את הדחיפות והסכנה בעצירה בשולי הדרך המהירה, ולכן הצוות שלנו מתעדף קריאות באזור זה.</p>
