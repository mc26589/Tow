  ...
  return (
    <main>
      ...
      <section className="py-12 container mx-auto px-4">
        ...
        <p className="mb-4">אנו מתמחים בחילוץ רכבים פרטיים, מסחריים ורכבי 4x4 לאורך כביש 22. אנו מבינים את הדחיפות שבחילוץ מהיר בכביש מהיר, ולכן הצוות שלנו ערוך להגעה מיידית.</p>
        <p className="mb-4 font-semibold text-red-600">שימו לב: איננו מספקים שירותי גרירה לאופנועים.</p>
