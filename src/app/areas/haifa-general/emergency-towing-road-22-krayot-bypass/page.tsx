    ...
    <main>
      ...
      <section className="py-16 bg-gray-900 text-white">
        <div className="container mx-auto px-4">
          ...
          <p className="mb-4">אנו מבינים את הדחיפות שבחילוץ בכביש מהיר. השירות שלנו מתמקד ברכבים פרטיים, מסחריים ורכבי 4x4. אנו מציעים מחירים הוגנים ושקיפות מלאה.</p>
          <p className="text-red-400 font-semibold">הערה: איננו מספקים שירותי גרירה לאופנועים.</p>
        </div>
      </section>
    </main>
  );
