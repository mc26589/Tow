  ...
  return (
    <main>
      ...
      <section className="py-12 container mx-auto px-4">
        ...
        <p className="mb-4">אם נתקעתם עם הרכב בכביש עוקף קריות (כביש 22), אנו מספקים שירותי גרירה וחילוץ מהירים ומקצועיים לכל סוגי הרכבים הפרטיים, המסחריים ורכבי 4x4. הצוות שלנו מכיר היטב את צירי התנועה באזור חיפה והקריות ומגיע לנקודת התקיעה בזמן הקצר ביותר.</p>
