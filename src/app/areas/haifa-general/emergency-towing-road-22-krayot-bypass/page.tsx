  ...
  return (
    <main>
      ...
      <section className="py-12 container mx-auto px-4">
        ...
        <p className="mb-4">
          אנו מספקים שירותי גרירה דחופים לכל סוגי הרכבים הפרטיים, המסחריים ורכבי 4x4 לאורך כביש 22. 
          הצוות שלנו ערוך להגעה מהירה לכל נקודה בציר עוקף קריות בכל שעה ביום ובלילה.
        </p>
        ...
        <ul className="list-disc pr-6 space-y-2">
          ...
          <li>הגעה מהירה ובטוחה לצירי תנועה מרכזיים.</li>
