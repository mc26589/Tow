    ...
    <main className="min-h-screen bg-neutral-950 text-neutral-100">
      <section className="gradient-trust text-white py-14 md:py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8">אנו מתמחים בגרירת רכבים, מסחריות ו-4x4. שימו לב: איננו מספקים שירותי גרירה לאופנועים.</p>
      ...
      <section className="py-16 container mx-auto px-4">
        ...
        <p className="mb-4">
          אנו מבינים את התסכול שבתקיעה בדרך. למרות שאיננו מטפלים באופנועים, הצוות שלנו עומד לרשות בעלי רכבים פרטיים ומסחריים באזור אחוזה והסביבה 24 שעות ביממה.
        </p>
