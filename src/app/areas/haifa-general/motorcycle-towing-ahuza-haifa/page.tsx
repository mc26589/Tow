  ...
  return (
    <main className="bg-neutral-950 text-neutral-100">
      ...
      <section className="py-16 container mx-auto px-4">
        ...
        <p className="mb-4">
          אנו מבינים את החשיבות של מענה מהיר כאשר הרכב נתקע. למרות שאיננו מטפלים באופנועים, הצוות שלנו ערוך לתת מענה מיידי לכל סוגי הרכבים הפרטיים והמסחריים באזור אחוזה והסביבה.
        </p>
