    ...
    <main className="bg-neutral-950 min-h-screen">
      ...
      <section className="py-16 container mx-auto px-4 text-white">
        ...
        <div className="prose prose-invert max-w-3xl">
          <p>נתקעת עם הרכב באזור אחוזה? הצוות שלנו ערוך ומוכן להעניק לך שירות מקצועי, מהיר ואמין 24 שעות ביממה.</p>
          <p><strong>הבהרה חשובה:</strong> השירות שלנו מיועד לרכבים פרטיים, רכבי 4x4 ורכבים מסחריים בלבד. איננו ערוכים לשינוע אופנועים או אופנועים כבדים.</p>
          <p>אנו מתחייבים למחירים הוגנים ושירות ללא פשרות. לכל צורך בגרירת רכב, צרו קשר עם המוקד שלנו וקבלו הצעת מחיר בטלפון.</p>
        </div>
      </section>
    </main>
  );
