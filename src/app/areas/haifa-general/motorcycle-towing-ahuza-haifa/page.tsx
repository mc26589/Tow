  ...
  return (
    <main>
      ...
      <section className="py-12 container mx-auto px-4">
        ...
        <p className="mb-4">
          אנו מבינים את החשיבות של מענה מהיר כאשר הרכב נתקע. למרות שאיננו מטפלים באופנועים, הצוות שלנו עומד לרשותך 24/7 לכל צורך בגרירת רכבים באזור אחוזה והסביבה.
        </p>
        <ul className="list-disc pr-6 space-y-2">
          <li>זמינות מלאה 24 שעות ביממה, 7 ימים בשבוע.</li>
          <li>ציוד גרירה מתקדם לרכבים פרטיים ומסחריים.</li>
          <li>מחירים הוגנים ושקיפות מלאה מול הלקוח.</li>
          <li>צוות מיומן ומקצועי המכיר היטב את צירי התנועה בחיפה.</li>
        </ul>
      </section>
    </main>
  );
