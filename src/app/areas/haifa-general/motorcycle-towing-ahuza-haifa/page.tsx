  ...
  return (
    <main>
      ...
      <section className="gradient-trust text-white py-14 md:py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl mb-8">
            ...
            אם נתקעת עם רכבך באזור אחוזה, אנו כאן לשירותך 24/7.
          </p>
      ...
      <section className="py-16 container mx-auto px-4">
        <h2 className="text-2xl font-bold mb-4">מדוע לבחור בנו לחילוץ רכב באחוזה?</h2>
        <ul className="list-disc pr-6 space-y-2">
          <li>זמינות מלאה 24 שעות ביממה, 7 ימים בשבוע.</li>
          <li>ציוד גרירה מתקדם המותאם לרכבים פרטיים ורכבי שטח.</li>
          <li>מחירים הוגנים ושקיפות מלאה מול הלקוח.</li>
          <li>הגעה מהירה לכל נקודה בשכונת אחוזה ובחיפה.</li>
        </ul>
      </section>
    </main>
  );
