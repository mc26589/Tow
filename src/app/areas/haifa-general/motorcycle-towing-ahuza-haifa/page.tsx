    ...
    <main className="bg-neutral-950 min-h-screen text-neutral-100">
      ...
      <section className="py-16 container mx-auto px-4">
        ...
        <p className="text-lg leading-relaxed mb-4">
          ...
          אנו מתמקדים במתן פתרונות גרירה לרכבים פרטיים, רכבי שטח ורכבים מסחריים.
        </p>
        <p className="text-lg leading-relaxed">
          למרות שאיננו מטפלים באופנועים, אנו הכתובת המקצועית ביותר לכל צורך אחר בדרכים בחיפה והקריות. 
          אנו מתחייבים למחירים הוגנים ושירות ללא פשרות.
        </p>
      </section>
    </main>
  );
