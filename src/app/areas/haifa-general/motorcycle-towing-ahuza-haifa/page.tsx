    ...
    <main>
      ...
      <section className="py-12 container mx-auto px-4">
        ...
        <p className="mb-4">
          ...
          אנו מבינים את החשיבות של הגעה מהירה ללקוח ומציעים מחירים הוגנים לכל סוגי הגרירה לרכבים פרטיים ומסחריים.
        </p>
        <p className="font-semibold text-red-600">
          הערה חשובה: השירות שלנו מיועד לרכבים בלבד. איננו מספקים שירותי גרירה לאופנועים מכל סוג שהוא.
        </p>
      </section>
    </main>
  );
