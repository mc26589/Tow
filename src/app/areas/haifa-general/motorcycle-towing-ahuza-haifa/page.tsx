    ...
    <main className="min-h-screen bg-neutral-950 text-neutral-100">
      <section className="gradient-trust text-white py-14 md:py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8">אנו מתמחים בגרירת רכבים, מסחריים ו-4x4. שימו לב: איננו מספקים שירותי גרירה לאופנועים.</p>
      ...
      <section className="py-16 container mx-auto px-4">
        <div className="max-w-3xl mx-auto space-y-6">
          <h2 className="text-2xl font-semibold">שירותי גרירה באזור אחוזה</h2>
          <p>
            אנו מבינים את החשיבות של מענה מהיר בעת תקלה בדרך. למרות שאיננו מטפלים באופנועים, הצי שלנו ערוך ומוכן לכל קריאה עבור רכבים פרטיים ומסחריים באזור אחוזה והסביבה.
          </p>
