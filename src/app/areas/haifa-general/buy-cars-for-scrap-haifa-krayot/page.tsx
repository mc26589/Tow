    ...
    <main className="bg-neutral-950 min-h-screen">
      ...
      <section className="gradient-trust text-white py-14 md:py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8">שירות מקצועי, מהיר ואמין לפינוי רכבים לפירוק מכל סוג. הצעת מחיר הוגנת בטלפון.</p>
      ...
      <section className="py-16 container mx-auto px-4 text-neutral-100">
        ...
        <p className="mb-4">אנו קונים רכבים לפירוק בחיפה והקריות ומעניקים שירות מלא הכולל גרירה ללא עלות נוספת. אנו מטפלים ברכבים ישנים, רכבים מושבתים, רכבים לאחר תאונות קשות ורכבים ללא טסט.</p>
        <ul className="list-disc list-inside space-y-2 mb-8">
          <li>שירות מהיר בכל אזור חיפה והקריות</li>
          <li>תשלום הוגן במקום</li>
          <li>פינוי מקצועי של רכבים פרטיים, מסחריים ו-4x4</li>
          <li>סיוע מלא בהורדת הרכב מהכביש</li>
        </ul>
        <p className="text-sm text-neutral-400 italic">*הערה: אנו לא מטפלים באופנועים. השירות מיועד לרכבים בלבד.</p>
      </section>
    </main>
  );
}