    ...
    <main>
      ...
      <section className="gradient-trust text-white py-14 md:py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl mb-8 max-w-2xl">
            זקוקים לשירותי גרירה דחופים בקרית ביאליק? אנו מציעים מענה מהיר 24/7 לרכבים פרטיים, מסחריים ורכבי שטח. אנו מתמחים בחילוץ וגרירה מקצועית במחירים הוגנים. חשוב לציין: איננו מספקים שירותי גרירה לאופנועים.
          </p>
      ...
      <section className="py-12 container mx-auto px-4">
        ...
        <ul className="space-y-4 text-lg">
          ...
          <li>✓ הגעה מהירה לכל נקודה בקרית ביאליק והקריות.</li>
        </ul>
      </section>
    </main>
  );
