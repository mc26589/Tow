  ...
  return (
    <main>
      ...
      <section className="py-12 container mx-auto px-4">
        ...
        <p className="mb-4">כביש 22 הוא עורק תחבורה מרכזי, וכשנתקעים בו, חשוב לקבל מענה בטיחותי ומהיר. אנו מתמחים בחילוץ רכבים תקועים, החלפת גלגלים, והתנעות, תוך שמירה על כללי הבטיחות בכביש מהיר.</p>
        ...
        <p>אנו מציעים מחירים הוגנים ושקופים. צרו קשר לקבלת הצעת מחיר בטלפון.</p>
      </section>
    </main>
  );
}