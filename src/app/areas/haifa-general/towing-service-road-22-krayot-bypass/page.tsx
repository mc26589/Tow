  ...
  return (
    <main>
      ...
      <section className="py-12 container mx-auto px-4">
        ...
        <p className="mb-4">
          אם הרכב שלכם נתקע בכביש 22 (עוקף קריות), אנו כאן כדי לספק לכם מענה מהיר ובטוח. 
          אנו מתמחים בחילוץ רכבים פרטיים, מסחריים ורכבי 4x4. 
          <strong>חשוב להבהיר:</strong> אנו לא מספקים שירותי גרירה לאופנועים.
        </p>
        <p>אנו מציעים מחירים הוגנים ושירות אדיב 24/7 לכל אורך ציר עוקף קריות.</p>
      </section>
    </main>
  );
}