    ...
    <main className="bg-neutral-950 text-neutral-100">
      ...
      <section className="py-16 container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mb-4">הצוות שלנו מצויד בציוד גרירה וחילוץ מתקדם המותאם במיוחד לקרקע בוצית וטובענית, ומבטיח חילוץ בטוח ללא נזק לרכב. אנו מציעים מחירים הוגנים ושירות אדיב 24/7.</p>
