...
export const metadata: Metadata = {
  ...
  description: "נתקעתם בבוץ באזור הכרמל? צוות חילוץ מקצועי זמין עבורכם 24/7. שירות מהיר, אמין ובמחיר הוגן לרכבים פרטיים ומסחריים."
};
    ...
    <main>
      ...
      <section className="gradient-trust text-white py-14 md:py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8">נתקעתם בבוץ? הצוות שלנו בדרך אליכם. שירות מקצועי לרכבים פרטיים, מסחריים ו-4x4.</p>
      ...
      <section className="py-12 container mx-auto px-4">
        ...
        <p>הצוות שלנו מגיע מצויד בכל הציוד הנדרש כדי להוציא את הרכב שלכם בבטחה, תוך הקפדה על מחירים הוגנים ושירות אדיב.</p>
      </section>
    </main>
  );
}