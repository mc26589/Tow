  ...
  return (
    <main className="bg-neutral-950 min-h-screen text-neutral-100">
      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <p className="mb-4">אם הרכב שלכם שקע בבוץ בדרכי העפר או בשטחים הפתוחים של הכרמל, אתם זקוקים למענה מיידי ומקצועי. אנו מתמחים בחילוצי שטח מורכבים לרכבים פרטיים, רכבי 4x4 ורכבים מסחריים.</p>
        ...
        <ul className="list-disc list-inside space-y-2 mb-6">
          ...
          <li>ציוד כננות וגרירה מקצועי המגן על הרכב שלכם.</li>
