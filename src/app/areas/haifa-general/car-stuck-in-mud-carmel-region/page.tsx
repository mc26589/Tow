  ...
  return (
    <main>
      ...
      <section className="py-12 container mx-auto px-4">
        ...
        <p className="mb-4">אם הרכב שלכם שקע בבוץ בדרכי העפר של הכרמל או באזורים בוציים בחיפה והקריות, אנחנו כאן כדי לסייע לכם באופן מיידי. אנו מתמחים בחילוצי שטח, רכבי 4x4 ורכבים פרטיים שנתקעו בתנאי שטח קשים.</p>
        ...
        <ul className="list-disc pr-6 space-y-2">
          ...
          <li>ציוד חילוץ מקצועי לרכבים פרטיים ומסחריים.</li>
          <li>שירות אדיב במחיר הוגן.</li>
        </ul>

        <div className="bg-gray-100 p-6 mt-8 rounded-lg border-r-4 border-red-600">
          <p className="font-bold">הערה חשובה:</p>
          <p>אנו מתמחים בחילוץ רכבים פרטיים, מסחריים ורכבי 4x4. איננו מספקים שירותי חילוץ או גרירה לאופנועים.</p>
        </div>
      </section>
    </main>
  );
