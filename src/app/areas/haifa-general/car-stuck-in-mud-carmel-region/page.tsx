    ...
    <main>
      ...
      <section className="py-12 bg-gray-900 text-white">
        <div className="container mx-auto px-4">
          ...
          <p className="mb-4">אנו מבינים את הקושי והלחץ שבהיתקעות בשטח. השירות שלנו מתמקד במקצועיות, בטיחות ומחירים הוגנים ללא הפתעות.</p>
          ...
          <p className="mt-6 text-sm text-gray-400">
            * שים לב: אנו מתמחים בחילוץ רכבים ורכבי שטח בלבד. איננו מספקים שירותי חילוץ לאופנועים.
          </p>
        </div>
      </section>
    </main>
