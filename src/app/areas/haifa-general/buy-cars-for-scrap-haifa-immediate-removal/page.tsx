    ...
    <main>
      ...
      <section className="gradient-trust text-white py-14 md:py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8">זקוקים לפינוי רכב ישן או תקול? אנחנו כאן לשירותכם 24/7 עם מענה מהיר ומקצועי.</p>
      ...
      <section className="py-16 bg-gray-900 text-white">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <p className="mb-4">אנו מציעים שירות אמין, מהיר ומקצועי לתושבי חיפה והקריות. אנו קונים רכבים לפירוק, רכבים לאחר תאונה ורכבים ללא טסט במחירים הוגנים.</p>
