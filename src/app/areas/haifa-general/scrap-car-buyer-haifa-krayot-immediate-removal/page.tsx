    ...
    <main>
      ...
      <section className="gradient-trust text-white py-14 md:py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8">זקוקים לפינוי רכב ישן או תקול? אנחנו כאן בשבילכם 24/7.</p>
      ...
      <section className="py-16 container mx-auto px-4">
        ...
        <p className="mb-4">
          ...
          אנו מציעים שירות מהיר, אמין ומקצועי לכל סוגי הרכבים הפרטיים, המסחריים ורכבי ה-4x4.
        </p>
