...
export const metadata: Metadata = {
  ...
  description: 'נתקעתם עם רכב ישן? פינוי רכב גרוטאה לחלפים בקריית מוצקין במזומן! גרירה חינם, שירות מהיר והוגן 24/7. התקשרו עכשיו לקבלת הצעת מחיר!',
  alternates: {
    ...
    <>
      ...
      <section className='gradient-trust text-white py-14 md:py-20'>
        <div className='container mx-auto px-4 text-center'>
          ...
          <p className='text-xl md:text-2xl mb-8 max-w-3xl mx-auto'>קונים רכבים ישנים, תקולים ולפירוק במזומן! שירות גרירה מהיר מהיום להיום.</p>
      ...
      <section className='bg-gray-900 text-white py-12 md:py-16'>
        <div className='container mx-auto px-4'>
          ...
          <p className='text-lg mb-6'>מחפשים <Link href='/areas/haifa-general/buy-cars-for-scrap-haifa-immediate-removal' className='text-blue-400 underline'>קונה רכבים לפירוק בחיפה והסביבה</Link>? אנחנו כאן בקריית מוצקין זמינים לתת לכם שירות מלא. בדומה לשירותי <Link href='/areas/haifa-general/buy-old-cars-for-scrap-kiryat-yam' className='text-blue-400 underline'>פינוי רכבים בקריית ים</Link>, אנו מעניקים מענה מהיר לכל סוגי הרכבים.</p>
