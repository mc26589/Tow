...
export const metadata: Metadata = {
  ...
  description: "זקוקים לגרר בצומת צ'ק פוסט? שירותי גרירה מהירים, מקצועיים ובמחירים הוגנים. זמינים לכל סוגי הרכבים 24 שעות ביממה.",
};
    ...
    <main>
      ...
      <section className="py-12 container mx-auto px-4">
        ...
        <ul className="space-y-4 text-lg">
          ...
          <li>✓ צוות מיומן שמכיר את עומסי התנועה באזור ויגיע אליכם במהירות.</li>
        </ul>
      </section>
    </main>
  );
