...
export const metadata: Metadata = {
  ...
  description: "נתקעתם בצומת צ'ק פוסט? שירותי גרירה מהירים, מקצועיים ובמחירים הוגנים. זמינים 24/7 לכל סוגי הרכבים. התקשרו עכשיו לחילוץ מהיר."
};
      ...
      <section className="gradient-trust text-white py-14 md:py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl mb-8 max-w-2xl">
            נתקעתם עם הרכב באזור צומת צ'ק פוסט? אנו מציעים שירותי גרירה מקצועיים ומהירים במחירים הוגנים. 
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <ul className="space-y-4 text-lg">
            ...
            <li>✓ צוות מיומן ומקצועי לטיפול בטוח ברכב שלכם.</li>
          </ul>
        </div>
      </section>
    </main>
