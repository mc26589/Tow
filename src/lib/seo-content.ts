...
const HERO_TIME_PROMISES = [
    ...
    "שירותי דרכים מהירים מסביב לשעון",
    "הגעה מהירה מובטחת באזור",
    "שגריר PRO בדרך אליכם עכשיו",
    "שירותי דרכים 24/7 — גרר כבר בדרך",
];
...
const SEO_HIDDEN_KEYWORDS = [
    ...
    "שירותי דרכים 24/7", "מוסך נייד", "גרירת אופנועים במקביל", "החלפת גלגל",
    "שגריר", "גרר", "איתוראן", "מנהרות הכרמל", "שירותי דרכים",
    "PRO גרירה", "KSP גרר", "פנצ'ר בדרך", "תקלה במנהרות הכרמל",
    "שגריר מהיר", "שירותי דרכים חיפה", "גרר PRO"
];
...
export function generateFAQs(cityName: string, vehicleName: string): FAQItem[] {
    ...
    const potentialFaqs = [
        ...
        {
            question: `מה עושים במקרה של פנצ'ר ב${cityName}?`,
            answer: `שירותי הדרכים שלנו כוללים גם טיפול בפנצ'ר במקום. אם לא ניתן לתקן את הפנצ'ר בשטח, שגריר מטעמנו יגיע לגרור את ה${vehicleName} שלכם למוסך הקרוב ב${cityName}. שירות PRO מהיר ומקצועי.`
        },
        {
            question: `נתקעתי במנהרות הכרמל — אתם מגיעים?`,
            answer: `בהחלט! אנו מספקים שירותי דרכים וגרירה גם במנהרות הכרמל ובכבישים המהירים בסביבת ${cityName}. שגריר מקצועי יגיע אליכם במהירות לחלץ את ה${vehicleName} בבטחה מלאה מהמנהרה.`
        },
        {
            question: `אני מנוי איתוראן — אתם עובדים איתם?`,
            answer: `אנחנו מספקים שירותי גרר וחילוץ עצמאיים ומהירים יותר, ללא תלות באיתוראן או כל חברת שירותי דרכים אחרת. ב${cityName} ניתן להזמין גרר ישירות דרכנו ולקבל מענה מיידי ומחיר שקוף, ללא המתנה.`
        },
        {
            question: `מה ההבדל בינכם לבין שגריר רגיל?`,
            answer: `אנחנו לא סתם שגריר. ${BUSINESS_INFO.name} מספקים שירותי דרכים ברמת PRO — ציוד גרר מתקדם, נהגים מוסמכים, וזמן הגעה שלא תמצאו בשירות רגיל. גרר מפרץ אקספרס הוא הבחירה המקצועית ב${cityName}.`
        }
    ];
