...
כללים חשובים:
- הנושא חייב להיות רלוונטי **רק** לאזור חיפה והקריות (קריית ביאליק, קריית מוצקין, קריית אתא, קריית ים, קריית חיים, נשר, טירת כרמל)
- אסור בשום אופן לכתוב על ערים אחרות (לא תל אביב, לא ירושלים, לא באר שבע, לא שום עיר אחרת)
- הנושא חייב להיות בתחום הרכב: גרירה, תקלות רכב, תחזוקה, אבחון בעיות, בטיחות בדרכים, חילוץ, רכב חשמלי, טיפולים
- תבחר נושא שאנשים מחפשים בגוגל לפני שהם צריכים גרר
...
כללים חשובים (חובה לעקוב!):
- המאמר חייב להיות רלוונטי **רק** לאזור חיפה והקריות
- אסור בשום אופן להזכיר או לכתוב על ערים אחרות (לא תל אביב, לא ירושלים, לא באר שבע, לא שום עיר מחוץ לאזור חיפה/קריות)
- המאמר חייב להיות בתחום הרכב בלבד: גרירה, תקלות, תחזוקה, אבחון, בטיחות, חילוץ, רכב חשמלי, טיפולים
...
8. הוסף הקשר מקומי — רחובות/שכונות בחיפה והקריות, כבישים ידועים (כביש 22, עוקף קריות, סטלה מאריס, הכרמל), מזג אוויר מקומי
